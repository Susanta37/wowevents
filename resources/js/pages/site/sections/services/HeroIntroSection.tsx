        ...
        <section className="relative overflow-hidden border-b border-white/[0.06] bg-[#080808]">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    ...
                    alt="Luxury event table design with gold accents"
                    className="h-full w-full object-cover object-center"
                    loading="eager"
                />
                {/* Left-to-transparent gradient overlay */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#080808] via-[#080808]/88 via-[#080808]/55 to-transparent" />
            ...
            >
                ...
                <div className="absolute -left-32 top-1/3 h-[600px] w-[600px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(212,175,55,0.1)_0%,transparent_60%)] blur-3xl" />
                {/* Chocolate glow at bottom */}
                <div className="absolute -bottom-48 left-1/4 h-[500px] w-[700px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(59,47,47,0.18)_0%,transparent_60%)] blur-3xl" />
                {/* Subtle gold accent on right side */}
                <div className="absolute -right-20 top-1/2 h-[450px] w-[450px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(212,175,55,0.05)_0%,transparent_60%)] blur-3xl" />
                {/* Secondary warm glow */}
                <div className="absolute left-1/3 top-2/3 h-[350px] w-[350px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(212,175,55,0.04)_0%,transparent_60%)] blur-3xl" />
            </div>
            ...
            <div className="relative z-10 mx-auto max-w-[1400px] px-6 pb-28 pt-32 lg:px-10 lg:pb-44 lg:pt-40">
                ...
                <div className="relative max-w-3xl">
                    ...
                    >
                        ...
                        >
                            <Gem className="h-3 w-3 text-[#d4af37]/40" />
                            Curated Services
                        </motion.span>
                    </motion.div>
                    ...
                    >
                        Planning, artistry, choreography—woven so your guests
                        perceive only seamless atmosphere. Each discipline
                        orchestrated to transform spaces into sensory
                        narratives.
                    </motion.p>
                    ...
                    >
                        ...
                        <p className="max-w-lg text-sm leading-relaxed text-stone-500 md:text-base">
                            From intimate celebrations to grand galas, our
                            curators design experiences that feel effortless yet
