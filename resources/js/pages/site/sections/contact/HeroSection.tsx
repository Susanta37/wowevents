...
export function HeroSection() {
    ...
    const conciergeStats = [
        { value: '48h', label: 'Response Window' },
        { value: '100%', label: 'Tailored Proposals' },
        { value: '1:1', label: 'Curator Partnership' },
    ];
        ...
        <section className="relative overflow-hidden border-b border-white/[0.06] bg-[#080808]">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    ...
                    alt="Luxury event planning with gold accents"
                    className="h-full w-full object-cover object-center"
                    loading="eager"
                />
                {/* Left-to-transparent gradient overlay */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#080808] via-[#080808]/90 via-[#080808]/55 to-transparent" />
                {/* Bottom vignette */}
            ...
            <div className="relative z-10 mx-auto max-w-[1400px] px-6 pb-28 pt-32 lg:px-10 lg:pb-44 lg:pt-40">
                ...
                <div className="relative max-w-3xl">
                    ...
                    >
                        ...
                        >
                            <Calendar className="h-3 w-3 text-[#d4af37]/40" />
                            Private Booking
                        </motion.span>
                    </motion.div>
                    ...
                    >
                        Share your vision in confidence. Our curators craft a
                        tailored concept within 48 hours—no generic proposals,
                    ...
                    >
                        ...
                        <p className="max-w-lg text-sm leading-relaxed text-stone-500 md:text-base">
                            Your dedicated curator listens, advises, and
                            orchestrates—translating your aspirations into a
                            meticulously composed event narrative.
                        </p>
                    </motion.div>
